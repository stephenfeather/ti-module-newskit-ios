...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.featherdirect.newskit.js')
	...
	f = os.path.join(cwd,'Classes','ComFeatherdirectNewskitModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.featherdirect.newskit.js']
