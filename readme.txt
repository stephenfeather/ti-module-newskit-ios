...
<modules>
	<module version="0.1">com.featherdirect.newskit</module>
</modules>
...
For example,
	...
	var my_module = require('com.featherdirect.newskit');
	my_module.foo();
...
To create a module, create a file named com.featherdirect.newskit.js under the assets folder.
